            ...
            {isMobileMenuOpen && (
                <div className="md:hidden border-t-2 border-accent/30 bg-card/95 backdrop-blur-sm">
                    <div className="px-2 pt-2 pb-3 space-y-1">
                        ...
                        {!user && (
                            <Button href="/account/login" variant="accent" className="block px-3 py-2 text-base font-medium text-accent-foreground bg-accent hover:bg-accent/80 rounded-lg transition-all shadow-md border border-accent" onClick={() => setIsMobileMenuOpen(false)}>
                                Login
                            </Button>
                        )}
                    </div>
