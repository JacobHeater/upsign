...
import { Button, Card, Icon } from '@/components/design-system';
...
export default function Home() {
  ...
  return (
    <div className="bg-background">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-primary-50 via-primary-100 to-primary-200 border-b-1">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <h1 className="text-4xl font-bold text-foreground sm:text-5xl md:text-6xl mb-6">
              <span className="block">Who's Bringing What?</span>
              <span className="block text-2xl sm:text-3xl md:text-4xl font-semibold mt-8">
                Coordinate Your Gathering
              </span>
            </h1>
            ...
            <div className="mt-8 max-w-md mx-auto sm:flex sm:justify-center md:mt-12 gap-4">
              <Button href="/events/create" variant="primary" className="group w-full flex items-center justify-center md:text-lg md:px-10">
                <span className="mr-2">✨</span>
                Create an Event
                <span className="ml-2 group-hover:translate-x-1 transition-transform">→</span>
              </Button>
              <Button href="/events" variant="accent" className="group mt-3 sm:mt-0 w-full flex items-center justify-center md:text-lg md:px-10">
                <span className="mr-2">📅</span>
                Browse Events
                <span className="ml-2 group-hover:translate-x-1 transition-transform">→</span>
              </Button>
      ...
      {/* Features Section */}
      <section className="py-20 bg-gradient-to-b from-primary-100 via-primary-200 to-primary-300 border-b-1">
          ...
          <div className="mt-16">
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <div className="pt-6 group relative">
                <div className="absolute -top-3 left-1/8 transform -translate-x-1/2 z-10">
                  <span className="inline-flex items-center justify-center p-4 rounded-xl border-2 border-accent/30 bg-accent/10 text-accent-foreground shadow-sm group-hover:shadow-accent/50 transition-all group-hover:scale-110">
                    <Icon name="calendar" size={28} className="text-accent-foreground" />
                  </span>
                </div>
              ...
              <div className="pt-6 group relative">
                <div className="absolute -top-3 left-1/8 transform -translate-x-1/2 z-10">
                  <span className="inline-flex items-center justify-center p-4 rounded-xl border-2 border-accent/30 bg-accent/10 text-accent-foreground shadow-sm group-hover:shadow-accent/50 transition-all group-hover:scale-110">
                    <Icon name="check" size={28} className="text-accent-foreground" />
                  </span>
                </div>
      ...
      <section className="relative bg-gradient-to-r from-primary-100 via-primary-200 to-primary-100 overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto text-center py-20 px-4 sm:py-24 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            <Button href={user ? "/events" : "/account/signup"} variant="primary" className="group inline-flex items-center justify-center">
              <span className="mr-2">🚀</span>
              Get Started Now
              <span className="ml-2 group-hover:translate-x-1 transition-transform">→</span>
            </Button>
